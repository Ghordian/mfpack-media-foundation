...
//
  ...
  SUBLANG_KASHMIRI_INDIA             = $02; // Kashmiri (India)
...
function GetFiberData: PVOID; assembler;
{$EXTERNALSYM GetFiberData}

function GetCurrentFiber: PVOID; assembler;
...
type
  ...
  TSecurityDecriptorControl = SECURITY_DESCRIPTOR_CONTROL;
  PSecurityDecriptorControl = PSECURITY_DESCRIPTOR_CONTROL;
...
function NtCurrentTeb: PNT_TIB; assembler;
...
//
  ...
  {$EXTERNALSYM JOB_OBJECT_LIMIT_RESERVED1}
...
//
  ...
  IMAGE_REL_IA64_LTOFF64   = $000F;
  {$EXTERNALSYM IMAGE_REL_IA64_LTOFF64}
  IMAGE_REL_IA64_DIR32NB   = $0010;
  {$EXTERNALSYM IMAGE_REL_IA64_DIR32NB}
  IMAGE_REL_IA64_SREL22    = $0011;
  {$EXTERNALSYM IMAGE_REL_IA64_SREL22}
  IMAGE_REL_IA64_UREL22    = $0012;
  {$EXTERNALSYM IMAGE_REL_IA64_UREL22}
...
type
  PIMAGE_IA64_RUNTIME_FUNCTION_ENTRY = ^IMAGE_IA64_RUNTIME_FUNCTION_ENTRY;
  {$EXTERNALSYM PIMAGE_IA64_RUNTIME_FUNCTION_ENTRY}
  _IMAGE_IA64_RUNTIME_FUNCTION_ENTRY = record
    BeginAddress: DWORD;
    EndAddress: DWORD;
    UnwindInfoAddress: DWORD;
  end;
  {$EXTERNALSYM _IMAGE_IA64_RUNTIME_FUNCTION_ENTRY}
  IMAGE_IA64_RUNTIME_FUNCTION_ENTRY = _IMAGE_IA64_RUNTIME_FUNCTION_ENTRY;
  {$EXTERNALSYM IMAGE_IA64_RUNTIME_FUNCTION_ENTRY}
  TImageIa64RuntimeFunctionEntry = IMAGE_IA64_RUNTIME_FUNCTION_ENTRY;
  PImageIa64RuntimeFunctionEntry = PIMAGE_IA64_RUNTIME_FUNCTION_ENTRY;
...
//
  ...
  {$EXTERNALSYM PIMAGE_ALPHA_RUNTIME_FUNCTION_ENTRY}
  ...
  {$EXTERNALSYM _IMAGE_ALPHA_RUNTIME_FUNCTION_ENTRY}
  IMAGE_ALPHA_RUNTIME_FUNCTION_ENTRY = _IMAGE_ALPHA_RUNTIME_FUNCTION_ENTRY;
  {$EXTERNALSYM IMAGE_ALPHA_RUNTIME_FUNCTION_ENTRY}
  TImageAlphaRuntimeFunctionEntry = IMAGE_ALPHA_RUNTIME_FUNCTION_ENTRY;
  PImageAlphaRuntimeFunctionEntry = PIMAGE_ALPHA_RUNTIME_FUNCTION_ENTRY;

  PIMAGE_ALPHA64_RUNTIME_FUNCTION_ENTRY = ^IMAGE_ALPHA64_RUNTIME_FUNCTION_ENTRY;
  {$EXTERNALSYM PIMAGE_ALPHA64_RUNTIME_FUNCTION_ENTRY}
  ...
  {$EXTERNALSYM _IMAGE_ALPHA64_RUNTIME_FUNCTION_ENTRY}
  IMAGE_ALPHA64_RUNTIME_FUNCTION_ENTRY = _IMAGE_ALPHA64_RUNTIME_FUNCTION_ENTRY;
  {$EXTERNALSYM IMAGE_ALPHA64_RUNTIME_FUNCTION_ENTRY}
  TImageAlpha64RuntimeFunctionEntry = IMAGE_ALPHA64_RUNTIME_FUNCTION_ENTRY;
  PImageAlpha64RuntimeFunctionEntry = PIMAGE_ALPHA64_RUNTIME_FUNCTION_ENTRY;

  IMAGE_AXP64_RUNTIME_FUNCTION_ENTRY = IMAGE_ALPHA64_RUNTIME_FUNCTION_ENTRY;
  {$EXTERNALSYM IMAGE_AXP64_RUNTIME_FUNCTION_ENTRY}
  PIMAGE_AXP64_RUNTIME_FUNCTION_ENTRY = PIMAGE_ALPHA64_RUNTIME_FUNCTION_ENTRY;
  {$EXTERNALSYM PIMAGE_AXP64_RUNTIME_FUNCTION_ENTRY}
